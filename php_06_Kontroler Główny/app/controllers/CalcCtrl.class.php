...
class CalcCtrl {
    ...
    public function validate(): bool {
        ...
        if ($this->form->loan_years == "" || $this->form->loan_years <= 0 ) {
        ...
        if (! getMessages()->isError()) {
            ...
            if ( is_int ( $this->form->loan_years )) {
    ...
    public function process() {
        ...
        if ($this->validate()) {
            ...
            if ($this->form->interest_rate <= 0) {
                $this->result_calc = $this->form->loan_amount / ($this->form->loan_years * 12);
            } else {
                $this->result_calc = ($this->form->loan_amount * (($this->form->interest_rate / 100) / 12) * ((1 + (($this->form->interest_rate / 100) / 12)) ** ($this->form->loan_years * 12))) / ((((1 + ($this->form->interest_rate  / 12 / 100)) ** ($this->form->loan_years* 12))) - 1);
            }
