...
<?php
$loan_amount = isset($loan_amount) ? $loan_amount : '';
$loan_years = isset($loan_years) ? $loan_years : '';
$interest_rate = isset($interest_rate) ? $interest_rate : '';
?>

<form action="<?php print(_APP_URL);?>/app/calc_loan.php" method="get" class="pure-form pure-form-stacked">
